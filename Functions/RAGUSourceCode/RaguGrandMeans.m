function [gm,Labels,CondLabels,GroupLabels] = RaguGrandMeans(V,Group,Cond,L1,L2,Gl)
...
if nargout > 1
    ...
    for g = 1:ngr
        for i = 1:nc1*nc2
            ...
            GroupLabels{g} = Gl{GroupIndex(g)};
        end
    end

    if nc1*nc2 == 1
        CondLabels{1} = 'All Conditions';
    end
        ...
        for c2 = 1:nc2
            ...
            for g = 1:ngr
                for c1 = 1:nc1
                    ...
                    if g == 1
                        CondLabels{c2+(c1-1)*nc2} = sprintf('%s ',CondLabels{c2+(c1-1)*nc2},c2txt);
                    end
                end
            end
        end
