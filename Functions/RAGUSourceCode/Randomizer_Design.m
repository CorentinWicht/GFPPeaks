...
set(handles.F1,'BackgroundColor',[0 1 0]);
...
if isnan(out.Design(sel,out.SelFactor))
    out.Design(sel,1:2) = 1;
else
    out.Design(sel,out.SelFactor) = out.Design(sel,out.SelFactor)+1;
end
set(handles.output,'UserData',out);
ShowData(out,handles);
